...
*/
	 ...
	 * DLAN play
	 *
	 * Smart Idea from: https://github.com/CharlesBlonde/libsoundtouch/blob/master/libsoundtouch/device.py
	 */
	play_url( url, handler) {


           console.log( this+" playing "+url);

	  // FIXME: escape URL or better XML builder...
	  var dlna_port = 8091;
	  var body =
		'<?xml version="1.0" encoding="utf-8"?>'+"\n"+
		...
		'	    <InstanceID>0</InstanceID><CurrentURIMetaData></CurrentURIMetaData><CurrentURI>'+url+'</CurrentURI>'+"\n"+ 
		'	</u:SetAVTransportURI>'+"\n"+
		'    </s:Body>'+"\n"+
		'</s:Envelope>';
	...
	*/
	...
	notify( key, url, handler) {
		...
		xml.ele('app_key', {}, key)
		xml.ele('url',     {}, url)
	        xml.ele('service', {}, 'doorbell')
	        xml.ele('reason',  {}, 'doorbell')
	        xml.ele('message', {}, 'doorbell')
		xml.ele('volume',  {}, 45)
